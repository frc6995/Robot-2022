...
public class ShooterTestC extends CommandBase implements Loggable {
  ...
  @Config
  private double frontTargetRPM = 1950;
  @Config
  private double backTargetRPM = 1950;
  ...
  public void initialize() {
    ...
    // frontTargetRPM = SmartDashboard.getNumber("frontRPM", 4000);
    // backTargetRPM = SmartDashboard.getNumber("backRPM", 2000);
  }
